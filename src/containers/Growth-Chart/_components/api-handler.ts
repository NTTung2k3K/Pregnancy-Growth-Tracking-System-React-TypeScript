...
export async function getGrowthChartStatuses() {
    try {
        const response = await fetch(`${BASE_URL}/growthchart/get-status-handler?isAdminUpdate=false`)
...
export async function getGrowthChartsPaginated(filters: GrowthChartFilters) {
    ...
    try {
        const response = await fetch(`${BASE_URL}/growthchart/get-growth-chart-pagination?${queryParams}`)
        const data = await response.json()
        return data
    } catch (error) {
        return {
...
export async function getMyGrowthChartsPaginated(filters: GrowthChartFilters) {
    ...
    try {
        const response = await fetch(`${BASE_URL}/growthchart/get-my-growth-chart-pagination?${queryParams}`)
        const data = await response.json()
        return data
    } catch (error) {
        return {
