    ...
    >
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-sky-800 px-9 py-4 text-base font-medium text-emerald-400 duration-300 hover:bg-sky-900"
        />
